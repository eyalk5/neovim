...
static _Bool ti_change(char_u *str, char_u **last) FUNC_ATTR_WARN_UNUSED_RESULT;
...
static BufhlLineStatus bufhl_clear_line(BufhlLine *lineinfo, int src_id, linenr_T lnum);
#include "nvim/func_attr.h"
