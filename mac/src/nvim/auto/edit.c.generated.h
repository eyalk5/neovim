...
static int ins_compl_add(char_u *const str, int len, const _Bool icase, char_u *const fname, char_u *const *const cptext, const _Bool cptext_allocated, const Direction cdir, int flags, const _Bool adup) FUNC_ATTR_NONNULL_ARG(1);
