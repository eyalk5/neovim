# 1 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 331 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2




# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/9.0.0/include/stdbool.h" 1 3 4
# 6 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
void *valloc(size_t);
# 7 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 8 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
pid_t tcgetsid(int);
# 10 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 11 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 13 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 19 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 24 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 33 "/Users/a/Documents/projects/neovim-src/src/nvim/lib/klist.h" 2
...
# 26 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 28 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 29 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 30 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 31 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 32 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
# 1 "/Users/a/Documents/projects/neovim-src/src/nvim/log.h" 1
# 33 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
...
# 34 "/Users/a/Documents/projects/neovim-src/src/nvim/os/pty_process_unix.c" 2
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (pid < 0) {
    status = -(*__error());
    do_log(3, ((void*)0), __func__, 72, 1, "forkpty failed: %s", strerror((*__error())));
    return status;
  } else if (pid == 0) {
    init_child(ptyproc);
  }
  ...
  if (master_status_flags == -1) {
    status = -(*__error());
    do_log(3, ((void*)0), __func__, 82, 1, "Failed to get master descriptor status flags: %s", strerror((*__error())));
    goto error;
  }
  if (fcntl(master, 4, master_status_flags | 0x0004) == -1) {
    status = -(*__error());
    do_log(3, ((void*)0), __func__, 87, 1, "Failed to make master descriptor non-blocking: %s", strerror((*__error())));
    goto error;
  }
  ...
  if (os_set_cloexec(master) == -1) {
    status = -(*__error());
    do_log(3, ((void*)0), __func__, 94, 1, "Failed to set CLOEXEC on ptmx file descriptor");
    goto error;
  }
...
static void init_child(PtyProcess *ptyproc) FUNC_ATTR_NONNULL_ALL
{
  ...
  if (proc->cwd && os_chdir(proc->cwd) != 0) {
    do_log(3, ((void*)0), __func__, 165, 1, "chdir failed: %s", strerror((*__error())));
    return;
  }
  ...
  do_log(3, ((void*)0), __func__, 172, 1, "execvp failed: %s: %s", strerror((*__error())), prog);
  _exit(122);
}
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (fd_dup < 0) {
    status = -(*__error());
    do_log(3, ((void*)0), __func__, 238, 1, "Failed to dup descriptor %d: %s", fd, strerror((*__error())));
    return status;
  }

  if (os_set_cloexec(fd_dup) == -1) {
    status = -(*__error());
    do_log(3, ((void*)0), __func__, 244, 1, "Failed to set CLOEXEC on duplicate fd");
    goto error;
  }

  status = uv_pipe_open(pipe, fd_dup);
  if (status) {
    do_log(3, ((void*)0), __func__, 251, 1, "Failed to set pipe to descriptor %d: %s", fd_dup, uv_strerror(status));
