...
const void *op_register_iter(const void *const iter, char *const name, yankreg_T *const reg, _Bool *is_unnamed) FUNC_ATTR_NONNULL_ARG(2, 3) FUNC_ATTR_WARN_UNUSED_RESULT;
...
_Bool op_register_set_previous(const char name) FUNC_ATTR_WARN_UNUSED_RESULT;
#include "nvim/func_attr.h"
