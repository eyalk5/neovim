# 1 "/Users/a/Documents/projects/neovim-src/src/nvim/channel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 331 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/a/Documents/projects/neovim-src/src/nvim/channel.c" 2
...
# 5 "/Users/a/Documents/projects/neovim-src/src/nvim/api/ui.h" 2
...
# 6 "/Users/a/Documents/projects/neovim-src/src/nvim/api/private/defs.h" 2
...
# 7 "/Users/a/Documents/projects/neovim-src/src/nvim/api/ui.h" 2
# 5 "/Users/a/Documents/projects/neovim-src/src/nvim/channel.c" 2
...
# 8 "/Users/a/Documents/projects/neovim-src/src/nvim/buffer_defs.h" 2
...
# 6 "/Users/a/Documents/projects/neovim-src/src/nvim/main.h" 2
...
# 6 "/Users/a/Documents/projects/neovim-src/src/nvim/channel.c" 2
...
# 7 "/Users/a/Documents/projects/neovim-src/src/nvim/channel.c" 2
...
# 9 "/Users/a/Documents/projects/neovim-src/src/nvim/channel.c" 2
# 1 "/Users/a/Documents/projects/neovim-src/src/nvim/msgpack_rpc/server.h" 1
# 10 "/Users/a/Documents/projects/neovim-src/src/nvim/channel.c" 2
...
# 11 "/Users/a/Documents/projects/neovim-src/src/nvim/channel.c" 2
...
# 12 "/Users/a/Documents/projects/neovim-src/src/nvim/channel.c" 2
...
# 13 "/Users/a/Documents/projects/neovim-src/src/nvim/channel.c" 2
...
{
# 232 "/Users/a/Documents/projects/neovim-src/src/nvim/channel.c"
  (void)chan;
  (void)ext_source;
...
{
  if (!(--channel->refcount)) {
    multiqueue_put_event(main_loop.fast_events, event_create(free_channel_event, 1, channel));;
  }
}
...
Channel *channel_job_start(char **argv, CallbackReader on_stdout,
                           ...
                           _Bool pty, _Bool rpc, _Bool detach, const char *cwd,
                         ...
                         int timeout, const char **error)
{
  ...
  channel_create_event(channel, ((void*)0));
  return channel->id;
}
...
size_t channel_send(uint64_t id, char *data, size_t len, const char **error)
{
  ...
  if (chan->streamtype == kChannelStreamStderr) {
    ...
    size_t written = fwrite(data, len, 1, __stderrp);
    xfree(data);
    return len * written;
  }
                                         ...
                                         size_t count, int status)
{
  ...
  multiqueue_put_event(chan->events, event_create(on_channel_event, 1, event_data));;
}
  ...
  if (eof) {
    if (reader->buffered) {
      if (reader->cb.type != kCallbackNone) {
        ...
        if (tv_dict_find(reader->self, type, -1) == ((void*)0)) {
          ...
          tv_dict_add_list(reader->self, type, strlen(type), data);
            ...
            channel_incref(chan);
            multiqueue_put_event(chan->events, event_create(on_buffered_error, 2, chan, type));;
        }
      } else {
        abort();
      }
...
static void on_buffered_error(void **args)
{
  ...
  emsgf((const char *) (libintl_gettext((char *)(e_streamkey))), (stream), (chan->id));
  channel_decref(chan);
}
...
static void channel_process_exit_cb(Process *proc, int status, void *data)
{
  ...
  if (status >= 0) {
    process_channel_event(chan, &chan->on_exit, "exit", ((void*)0), 0, status);
  }
