...
int file_open_fd(FileDescriptor *const ret_fp, const int fd, const _Bool wr) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT;
...
FileDescriptor *file_open_fd_new(int *const error, const int fd, const _Bool wr) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_MALLOC FUNC_ATTR_WARN_UNUSED_RESULT;
